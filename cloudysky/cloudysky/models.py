...
class Media(models.Model):
    ...
    file = models.FileField(
        upload_to='media/',
        validators=[FileExtensionValidator(allowed_extensions=['jpg','jpeg','png','gif','mp4','pdf'])]
    )
...
class Post(models.Model):
    ...
    hidden_reason = models.ForeignKey(
        SuppressionReason, null=True, blank=True, on_delete=models.SET_NULL, related_name='posts'
    )
...
class Comment(models.Model):
    ...
    is_hidden = models.BooleanField(default=False)
    hidden_reason = models.ForeignKey(
        SuppressionReason, null=True, blank=True, on_delete=models.SET_NULL, related_name='comments'
    )
    hidden_at = models.DateTimeField(null=True, blank=True)
